# -*- coding: utf-8 -*-
#
# CopulaFurtif Manual documentation build configuration file, created by
...
latex_documents = [ ('index', 'CopulaFurtif.tex', u'CopulaFurtif Manual', authors(),
    "howto" ) ]
...
texinfo_documents = [
  ('index', 'CopulaFurtifManual', u'CopulaFurtif Manual', authors(), 'CopulaFurtifManual', 
    'CopulaFurtif -- a tool to make copula analysis on trading data', 'Miscellaneous'),
]
