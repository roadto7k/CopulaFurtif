...
from SaucissonPerime.Copulas.metrics.tail_dependance import compare_tail_dependence
...
def main():
    ...
    # Here we assume compare_tail_dependence
    result_df = compare_tail_dependence(data, candidate_list,
                                                 q_low=0.05, q_high=0.95, verbose=True)
    print(result_df)

    # --- Plot Tail Dependence Visualization ---
    plot_tail_dependence(data, candidate_list, q_low=0.05, q_high=0.95)
