"""
Comprehensive unit-test suite for the bivariate **BB9** Archimedean Copula

Structure, swagger, and paranoia all borrowed from the earlier Clayton
test file — just flipped for the BB9 flavour.
...
• Tail-dependence formulas (λ_L < 1, λ_U > 0 for BB9).
...
def copula_default():
    """Default BB9 copula with (θ, δ) = (2.0, 1.5)."""
    c = BB9Copula()
