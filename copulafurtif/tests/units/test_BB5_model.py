"""
Comprehensive unit-test suite for the bivariate **BB5** Archimedean Copula

Structure, swagger, and paranoia all borrowed from the earlier Clayton
test file — just flipped for the BB5 flavour.
...
• Tail-dependence formulas (λ_L < 1, λ_U > 0 for BB5).
...
def copula_default():
    """Default BB5 copula with (θ, δ) = (2.0, 1.5)."""
    c = BB5Copula()
