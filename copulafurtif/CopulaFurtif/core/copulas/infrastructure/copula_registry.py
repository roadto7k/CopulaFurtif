...
CopulaFactory.register(CopulaType.TAWNT2, TawnT2Copula)
...
CopulaFactory.register(CopulaType.HUSLER_REISS, HuslerReissCopula)
CopulaFactory.register(CopulaType.MARSHALL_OLKIN, MarshallOlkinCopula)
